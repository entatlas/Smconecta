...
export async function sendSupportEmail(subject: string, message: string, attachments: any[] = []) {
  try {
    ...
    const mailOptions: any = {
      from: '"Suporte SM Soluções - Candidato" <atlasupi@gmail.com>',
      to: 'atlasupi@gmail.com', // E-mail da Atlas
      subject: `[Suporte SM Soluções - CANDIDATO] ${subject}`,
      html: `
        <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
          <h2 style="color: #0056b3;">Nova Mensagem de Suporte (CANDIDATO)</h2>
          <p><strong>Remetente (Candidato):</strong> ${userName} (${userEmail})</p>
